...
function GameServer() {
    ...
    this.config = { // Border - Right: X increases, Down: Y increases (as of 2015-05-20)
        ...
        foodSpawnAmount: 110000000000000000, // The amount of food to spawn per interval
        foodStartAmount: 30000, // The starting amount of food in the map
        foodMaxAmount: 500, // Maximum food cells on the map
        foodMass: 1, // Starting food size (In mass)
        virusMinAmount: 10, // Minimum amount of viruses on the map.
        virusMaxAmount: 50, // Maximum amount of viruses on the map. If this amount is reached, then ejected cells will pass through viruses.
        virusStartMass: 100, // Starting virus size (In mass)
        virusFeedAmount: 2, // Amount of times you need to feed a virus to shoot it
        ...
        playerStartMass: 10000000, // Starting mass of the player cell.
        playerMaxMass: 200000000, // Maximum mass a player can have
        playerMinMassEject: 32, // Mass required to eject a cell
        playerMinMassSplit: 36, // Mass required to split
        playerMaxCells: 200, // Max cells the player is allowed to have
